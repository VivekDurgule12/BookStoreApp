...
function Navbar() {
    ...
    return (
        <>
            <div className={`w-full fixed top-0 left-0 right-0 bg-base-100 z-50 ${
                ...
                <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
                    <div className="navbar">
                        <div className="navbar-start">
                            ...
                            <a className="text-xl cursor-pointer">BookStore</a>
                        </div>
                        <div className="navbar-end space-x-3">
                            ...
                            <div className='hidden md:block'>
                                <label className="px-3 py-1 border rounded-md flex items-center gap-2">
                                    <input type="text" className="grow outline-none bg-none" placeholder="Search" />
                            ...
                            <div className="">
                                <a className="bg-black text-white p-2 rounded-md hover:bg-slate-800 duration-300" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
